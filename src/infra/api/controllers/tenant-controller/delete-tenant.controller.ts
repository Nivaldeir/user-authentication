...
import { DeleteTenant } from "../../../../core/domain/usecase/tenant/delete-tenant";

export class DeleteTenantController implements Controller {
  constructor(
    private readonly path: string,
    private readonly method: HttpMethod,
    private readonly service: DeleteTenant
  ) {}
  getHandler(): (
    request: Request<any>,
