...
import { DeleteUser } from "../../../../core/domain/usecase/user/delete-user";
import Middlware from "../../middleware";
import { userDelete } from "./schema/user-schema";

export class DeleteUserController implements Controller {
  constructor(
    private readonly path: string,
    private readonly method: HttpMethod,
    private readonly service: DeleteUser
  ) {}
  // @Middlware.validateSchema(userDelete)
  getHandler(): (
    request: Request<any>,
